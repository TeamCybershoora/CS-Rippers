  ...
  return (
    <div className="macos-menubar">
      <div className="menubar-left">
        ...
        <span className="menu-item active">CS RIPPERS</span>
        <span className="menu-item" onClick={handleAboutClick}>
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="menu-icon">
      ...
      <div className="menubar-right">
        <div className="system-controls">
          ...
          <span className="menu-item system-icon" title="System Preferences">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <circle cx="12" cy="12" r="3"/>
              <path d="M12 1v6m0 6v6m11-7h-6m-6 0H1m15.5-3.5L19 8.5m-14 7L7.5 13m11 3.5L16.5 19m-9-9L5 7.5"/>
            </svg>
          </span>
          <span className="menu-item datetime" title={tooltipText}>
